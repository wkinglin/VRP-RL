...
from parco.models.utils import resample_batch

log = get_pylogger(__name__)


class MAPDPRLModule(SymNCO):
    """RL LightningModule for MAPDP based on RL4COLitModule"""
        ...
        if phase == "train":
            ...
            if self.allow_multi_dataloaders:
                ...
                if dataloader_idx is not None and self.dataloader_names is not None:
                    # e.g. mtsp_n50_m7 take only number after "m" until _
                    num_agents = int(
